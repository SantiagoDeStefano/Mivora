...
export default function UpdateProfile({ profile, onCancel, onSaved }: Props) {
  ...
  const roles: string[] = Array.isArray(me.role)
    ? me.role
    : me.role
    ? [me.role]
    : [];
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    {isAttendee ? (
                      <Badge tone="pink">Attendee</Badge>
                    ) : (
                      <Badge tone="neutral">Organizer</Badge>
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6">
              ...
              <form className="flex flex-col items-center gap-5">
                <div className="w-full max-w-sm">
                  <label
                    htmlFor="pf-name"
                    className="block text-sm font-medium mb-1 text-center sm:text-left"
                  >
                    Full name
                  </label>
                  <input
