      ...
      <Container>
        <div className="flex h-14 items-center gap-2">
          ...
          <div className="ml-auto flex items-center gap-1">
            ...
            {/* Search: desktop field, mobile icon */}
            ...
            <button
              className="sm:hidden inline-flex h-9 w-9 items-center justify-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
            ...
            {/* MOBILE: show a small Log in button */}
        ...
        {showSearch && (
          <div className="sm:hidden pb-3">
            <div className="flex items-center gap-2 rounded-xl border border-gray-300 px-3 py-2 dark:border-gray-700">
              ...
              <input className="flex-1 bg-transparent text-sm outline-none" placeholder="Search…" aria-label="Search" />
